    ...
    <nav className="bg-black flex justify-between items-center league-spartan w-full h-16 mdNavBarHeight xl:px-4 2xl:px-16 overflow-hidden">
      ...
      <div>
        <ul>
          <li className="pr-5">
            <Link href="/">
              <button className="bg-white text-black text-sm py-1 px-2.5 md:text-base lg:text-xl lg:py-2 lg:px-4 xl:text-2xl rounded-full tracking-tight" aria-label="Contact Teleta Development">
                Contact
              </button>
            </Link>{" "}
          </li>
